...
export default {
  ...
  methods: {
    ...
    updateCurSingerInfo(singerId) {
      let isExist = this.singerInfo.find(obj => obj.id == singerId)
      if (isExist) {
